...
pub const SUPPORTED_STEAM_VERSIONS: [i64; 10] = [
    1788291500, 1782866176, 1782344391, 1782257239, 1781041600, 1780352834, 1779918128, 1779486452, 1778281814,
    1778003620,
];

pub fn is_supported_steam_version(version: i64) -> bool {
    SUPPORTED_STEAM_VERSIONS.contains(&version) || crate::cloud_redirect::steam_specs_cloud::is_cloud_supported_version(version)
}
